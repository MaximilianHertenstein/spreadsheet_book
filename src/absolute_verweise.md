...
Dafür wird mit dem Einzelpreis multipliziert. Die Formel dafür lautet `A2 * E1`.
...
Um zu verhindern, dass ein Zeile in einer Formel ersetzt wird, kann man vor dieser ein Dollarzeichen(`$`) schreiben.
